 ...
 *
 * Extracted out of HomePage.jsx as its own pure function purely so
 * the actual fix for the "generated content disappears when
 * switching study tabs" bug has a real, isolated unit test (see
 * cachedContent.test.js) — HomePage.jsx itself has no test harness
 ...
 * empty object rather than throwing, since HomePage's cachedContent
